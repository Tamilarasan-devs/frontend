        ...
        <div className="hidden lg:flex lg:w-[52%] relative overflow-hidden flex-col justify-between p-12"
          ...
          <div className="relative z-10 float-left">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-2xl bg-white/15 flex items-center justify-center backdrop-blur-sm border border-white/20">
                <span className="text-white font-black text-lg" style={{ fontFamily: "'Libre Baskerville',serif" }}>W</span>
              </div>
              <span className="text-white font-bold text-xl tracking-tight" style={{ fontFamily: "'Libre Baskerville',serif" }}>
                Wellness
              </span>
            </div>
          </div>
          ...
          <div className="relative z-10 float-left delay-1">
            ...
            <h1 className="text-4xl xl:text-5xl font-bold text-white leading-tight mb-6"
              ...
              <span className="text-orange-300">Wellness.</span>
            </h1>
        ...
        <div className="flex-1 flex items-center justify-center px-5 py-12 sm:px-10">
          <div className="w-full max-w-md">
            ...
            <div className="flex lg:hidden items-center gap-2 mb-8 fade-up">
              ...
              <span className="font-bold text-gray-900 text-lg" style={{ fontFamily: "'Libre Baskerville',serif" }}>Wellness</span>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {/* Divider */}
              <div className="fade-up delay-5 flex items-center gap-3 py-1">
              ...
              {/* Social logins */}
              <div className="fade-up delay-5 grid grid-cols-2 gap-3">
                {[
                  {
                    name: "Google",
                    icon: (
                  ...
                  <button key={s.name} type="button"
                    className="flex items-center justify-center gap-2.5 py-3 rounded-xl border-2 border-gray-200 bg-white text-sm font-semibold text-gray-700 cursor-pointer hover:border-gray-300 hover:shadow-md transition-all duration-200">
                    {s.icon}
                    {s.name}
                  </button>
                ))}
