      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        >
          ...
          <p style={{ color: "#a07060", fontSize: 16, maxWidth: 400, margin: "0 auto", lineHeight: 1.85 }}>
            Enter your Order ID below for real-time delivery updates on your Aayubakwath order.
          </p>
        </div>
            ...
            >
              ...
              <div className="to-icard" style={{ background: "#fff", borderRadius: 20, border: "1px solid rgba(201,100,58,.14)", padding: "22px 24px", boxShadow: "0 4px 20px rgba(130,12,12,.06)" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                  ...
                  <a href="mailto:support@Aayubakwath.com" className="to-clink" style={{ display: "flex", alignItems: "center", gap: 12, textDecoration: "none", padding: "11px 14px", background: "#fdf8f5", borderRadius: 12, border: "1px solid rgba(201,100,58,.1)" }}>
                    <FaEnvelope size={12} color={BRAND} />
                    <span style={{ color: "#4a2010", fontSize: 13, fontWeight: 600 }}>support@Aayubakwath.com</span>
                  </a>
                </div>
              </div>
            </div>
